...
module dexlyn_swap::coin_helper {
    use std::option;
    ...
    use dexlyn_swap::curves::is_stable;
    ...
    /// the result will be `(b"DexlynLP-BTC-USDT-U", b"BTC-USDT+")`
    public fun generate_lp_name_and_symbol<X, Y, Curve>(): (String, String) {
        let lp_name = string::utf8(b"");
        string::append_utf8(&mut lp_name, b"DexlynLP-");
